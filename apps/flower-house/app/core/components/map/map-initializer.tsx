...
import MapComponent from "@/app/core/components/map/map"; // `Map`을 `MapComponent`로 이름 변경하여 혼동 방지
import Markers from "@/app/core/components/map/markers";
import { MARKERS } from "@/app/core/constants/dummy";
import useMap, { INITIAL_CENTER, INITIAL_ZOOM } from "@/app/core/hooks/use-map"; // 임포트 경로 수정
import useMarkers from "@/app/core/hooks/use-markers";
import getCurrentLocation from "@/app/core/libs/map/get-current-location";
